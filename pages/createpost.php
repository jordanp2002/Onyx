...
<body>
    ...
    <div class="PostCreation">
        <form class="titlePost">
            ...
            <textarea id="postTitle" name="postTitle" rows="2" cols="50" maxlength="50" minlength="1" placeholder="Title here"></textarea>
        </form>
        <form class="post">
            <label for="postContent" type="hidden"></label>
            <textarea id="postContent" name="postContent" rows="4" cols="50" maxlength="500" minlength="1" placeholder="Text here max 500 characters"></textarea>
            <br>
            <button class="submit-button" type="button" onclick="validateAndSubmit()">Submit</button>
            <button class="delete-button" type="button" onclick="clearFields()">Delete</button>
        </form>
    </div>
</body>
